...
LOCAL_PRODUCTS = {
    ...
    'хлеб ржаной': {'name': 'Хлеб ржаной', 'calories': 165, 'protein_g': 6, 'fat_total_g': 1, 'carbohydrates_total_g': 34},
    ...
    'булочка': {'name': 'Булочка сдобная', 'calories': 339, 'protein_g': 8, 'fat_total_g': 4, 'carbohydrates_total_g': 70},
    'багет': {'name': 'Багет французский', 'calories': 285, 'protein_g': 11, 'fat_total_g': 2, 'carbohydrates_total_g': 56},
    'сухари': {'name': 'Сухари пшеничные', 'calories': 331, 'protein_g': 11, 'fat_total_g': 2, 'carbohydrates_total_g': 72},
    ...
    'тост': {'name': 'Тост из белого хлеба', 'calories': 290, 'protein_g': 9, 'fat_total_g': 4, 'carbohydrates_total_g': 55},
    'молоко': {'name': 'Молоко 2.5%', 'calories': 52, 'protein_g': 3, 'fat_total_g': 2.5, 'carbohydrates_total_g': 5},
    'молоко 3.2%': {'name': 'Молоко 3.2%', 'calories': 60, 'protein_g': 3, 'fat_total_g': 3.2, 'carbohydrates_total_g': 5},
    'молоко 1.5%': {'name': 'Молоко 1.5%', 'calories': 45, 'protein_g': 3, 'fat_total_g': 1.5, 'carbohydrates_total_g': 5},
    'молоко обезжиренное': {'name': 'Молоко обезжиренное', 'calories': 35, 'protein_g': 3, 'fat_total_g': 0.1, 'carbohydrates_total_g': 5},
    'кефир': {'name': 'Кефир 2.5%', 'calories': 53, 'protein_g': 3, 'fat_total_g': 2.5, 'carbohydrates_total_g': 4},
    'кефир 3.2%': {'name': 'Кефир 3.2%', 'calories': 56, 'protein_g': 3, 'fat_total_g': 3.2, 'carbohydrates_total_g': 4},
    ...
    'творог обезжиренный': {'name': 'Творог обезжиренный', 'calories': 85, 'protein_g': 18, 'fat_total_g': 0.5, 'carbohydrates_total_g': 2},
    ...
    'сыр голландский': {'name': 'Сыр голландский', 'calories': 352, 'protein_g': 26, 'fat_total_g': 27, 'carbohydrates_total_g': 0},
    'сыр чеддер': {'name': 'Сыр чеддер', 'calories': 402, 'protein_g': 25, 'fat_total_g': 33, 'carbohydrates_total_g': 1},
    ...
    'йогурт': {'name': 'Йогурт натуральный', 'calories': 68, 'protein_g': 5, 'fat_total_g': 3, 'carbohydrates_total_g': 4},
    'йогурт греческий': {'name': 'Йогурт греческий', 'calories': 59, 'protein_g': 10, 'fat_total_g': 0.4, 'carbohydrates_total_g': 3.6},
    'йогурт питьевой': {'name': 'Йогурт питьевой', 'calories': 72, 'protein_g': 3, 'fat_total_g': 2, 'carbohydrates_total_g': 10},
    'сметана': {'name': 'Сметана 15%', 'calories': 158, 'protein_g': 3, 'fat_total_g': 15, 'carbohydrates_total_g': 3},
    'сметана 20%': {'name': 'Сметана 20%', 'calories': 206, 'protein_g': 3, 'fat_total_g': 20, 'carbohydrates_total_g': 3},
    'сметана 10%': {'name': 'Сметана 10%', 'calories': 115, 'protein_g': 3, 'fat_total_g': 10, 'carbohydrates_total_g': 3},
    'сливки': {'name': 'Сливки 10%', 'calories': 118, 'protein_g': 3, 'fat_total_g': 10, 'carbohydrates_total_g': 4},
    'сливки 20%': {'name': 'Сливки 20%', 'calories': 205, 'protein_g': 3, 'fat_total_g': 20, 'carbohydrates_total_g': 4},
    'сливки 33%': {'name': 'Сливки 33%', 'calories': 322, 'protein_g': 2, 'fat_total_g': 33, 'carbohydrates_total_g': 3},
    'ряженка': {'name': 'Ряженка', 'calories': 54, 'protein_g': 3, 'fat_total_g': 2.5, 'carbohydrates_total_g': 4},
    'простокваша': {'name': 'Простокваша', 'calories': 58, 'protein_g': 3, 'fat_total_g': 3.2, 'carbohydrates_total_g': 4},
    'курица': {'name': 'Куриная грудка', 'calories': 113, 'protein_g': 23, 'fat_total_g': 2, 'carbohydrates_total_g': 0},
    'куриная грудка': {'name': 'Куриная грудка', 'calories': 113, 'protein_g': 23, 'fat_total_g': 2, 'carbohydrates_total_g': 0},
    'куриное бедро': {'name': 'Куриное бедро', 'calories': 209, 'protein_g': 26, 'fat_total_g': 11, 'carbohydrates_total_g': 0},
    'куриное филе': {'name': 'Куриное филе', 'calories': 113, 'protein_g': 23, 'fat_total_g': 2, 'carbohydrates_total_g': 0},
    'куриные крылышки': {'name': 'Куриные крылышки', 'calories': 222, 'protein_g': 19, 'fat_total_g': 16, 'carbohydrates_total_g': 0},
    'индейка': {'name': 'Индейка', 'calories': 135, 'protein_g': 25, 'fat_total_g': 3, 'carbohydrates_total_g': 0},
    'индейка грудка': {'name': 'Индейка грудка', 'calories': 135, 'protein_g': 25, 'fat_total_g': 3, 'carbohydrates_total_g': 0},
    'индейка бедро': {'name': 'Индейка бедро', 'calories': 144, 'protein_g': 18, 'fat_total_g': 8, 'carbohydrates_total_g': 0},
    'говядина': {'name': 'Говядина', 'calories': 187, 'protein_g': 19, 'fat_total_g': 12, 'carbohydrates_total_g': 0},
    'говяжий фарш': {'name': 'Говяжий фарш', 'calories': 254, 'protein_g': 17, 'fat_total_g': 20, 'carbohydrates_total_g': 0},
    'говядина вырезка': {'name': 'Говядина вырезка', 'calories': 175, 'protein_g': 22, 'fat_total_g': 9, 'carbohydrates_total_g': 0},
    'свинина': {'name': 'Свинина', 'calories': 242, 'protein_g': 25, 'fat_total_g': 15, 'carbohydrates_total_g': 0},
    'свиная вырезка': {'name': 'Свиная вырезка', 'calories': 143, 'protein_g': 21, 'fat_total_g': 6, 'carbohydrates_total_g': 0},
    'свиной фарш': {'name': 'Свиной фарш', 'calories': 263, 'protein_g': 16, 'fat_total_g': 22, 'carbohydrates_total_g': 0},
    ...
    'колбаса вареная': {'name': 'Колбаса вареная', 'calories': 257, 'protein_g': 13, 'fat_total_g': 22, 'carbohydrates_total_g': 3},
    'колбаса сырокопченая': {'name': 'Колбаса сырокопченая', 'calories': 473, 'protein_g': 24, 'fat_total_g': 41, 'carbohydrates_total_g': 0},
    'колбаса полукопченая': {'name': 'Колбаса полукопченая', 'calories': 350, 'protein_g': 16, 'fat_total_g': 30, 'carbohydrates_total_g': 3},
    ...
    'тунец консервированный': {'name': 'Тунец консервированный', 'calories': 198, 'protein_g': 29, 'fat_total_g': 8, 'carbohydrates_total_g': 0},
    ...
    'икра красная': {'name': 'Икра красная', 'calories': 251, 'protein_g': 31, 'fat_total_g': 13, 'carbohydrates_total_g': 1},
    'икра черная': {'name': 'Икра черная', 'calories': 264, 'protein_g': 25, 'fat_total_g': 18, 'carbohydrates_total_g': 4},
    ...
    'крабовые палочки': {'name': 'Крабовые палочки', 'calories': 88, 'protein_g': 17, 'fat_total_g': 0.5, 'carbohydrates_total_g': 0},
    ...
    'яичный белок': {'name': 'Яичный белок', 'calories': 52, 'protein_g': 11, 'fat_total_g': 0.2, 'carbohydrates_total_g': 1},
    'яичный желток': {'name': 'Яичный желток', 'calories': 322, 'protein_g': 16, 'fat_total_g': 27, 'carbohydrates_total_g': 3.6},
    'перепелиные яйца': {'name': 'Перепелиные яйца', 'calories': 168, 'protein_g': 14, 'fat_total_g': 13, 'carbohydrates_total_g': 0.6},
    'гречка': {'name': 'Гречка', 'calories': 132, 'protein_g': 4.5, 'fat_total_g': 1.3, 'carbohydrates_total_g': 27},
    'гречка отварная': {'name': 'Гречка отварная', 'calories': 101, 'protein_g': 4, 'fat_total_g': 1, 'carbohydrates_total_g': 21},
    'рис': {'name': 'Рис белый', 'calories': 130, 'protein_g': 2.7, 'fat_total_g': 0.3, 'carbohydrates_total_g': 28},
    'рис отварной': {'name': 'Рис отварной', 'calories': 116, 'protein_g': 2.2, 'fat_total_g': 0.5, 'carbohydrates_total_g': 25},
    'рис бурый': {'name': 'Рис бурый', 'calories': 111, 'protein_g': 2.6, 'fat_total_g': 0.9, 'carbohydrates_total_g': 23},
    'овсянка': {'name': 'Овсянка', 'calories': 68, 'protein_g': 2.4, 'fat_total_g': 1.4, 'carbohydrates_total_g': 12},
    'овсяные хлопья': {'name': 'Овсяные хлопья', 'calories': 379, 'protein_g': 13, 'fat_total_g': 6.5, 'carbohydrates_total_g': 67},
    'манка': {'name': 'Манка', 'calories': 328, 'protein_g': 10, 'fat_total_g': 1, 'carbohydrates_total_g': 73},
    'перловка': {'name': 'Перловка', 'calories': 123, 'protein_g': 2.3, 'fat_total_g': 0.4, 'carbohydrates_total_g': 28},
    'пшено': {'name': 'Пшено', 'calories': 119, 'protein_g': 3.5, 'fat_total_g': 1, 'carbohydrates_total_g': 23},
    'ячневая крупа': {'name': 'Ячневая крупа', 'calories': 313, 'protein_g': 10, 'fat_total_g': 1.3, 'carbohydrates_total_g': 65},
    'кукурузная крупа': {'name': 'Кукурузная крупа', 'calories': 337, 'protein_g': 8.3, 'fat_total_g': 1.2, 'carbohydrates_total_g': 75},
    ...
    'макароны отварные': {'name': 'Макароны отварные', 'calories': 158, 'protein_g': 5.8, 'fat_total_g': 0.9, 'carbohydrates_total_g': 30},
    'спагетти': {'name': 'Спагетти', 'calories': 158, 'protein_g': 5.8, 'fat_total_g': 0.9, 'carbohydrates_total_g': 30},
    'лапша': {'name': 'Лапша яичная', 'calories': 384, 'protein_g': 12, 'fat_total_g': 4.5, 'carbohydrates_total_g': 75},
    'лапша гречневая': {'name': 'Лапша гречневая', 'calories': 348, 'protein_g': 14, 'fat_total_g': 0.9, 'carbohydrates_total_g': 72},
    'лапша рисовая': {'name': 'Лапша рисовая', 'calories': 364, 'protein_g': 6, 'fat_total_g': 0.6, 'carbohydrates_total_g': 82},
    'вермишель': {'name': 'Вермишель', 'calories': 157, 'protein_g': 5.3, 'fat_total_g': 1, 'carbohydrates_total_g': 31},
    'картофель': {'name': 'Картофель', 'calories': 77, 'protein_g': 2, 'fat_total_g': 0.1, 'carbohydrates_total_g': 17},
    'картофель отварной': {'name': 'Картофель отварной', 'calories': 82, 'protein_g': 2, 'fat_total_g': 0.4, 'carbohydrates_total_g': 18},
    'картофель жареный': {'name': 'Картофель жареный', 'calories': 192, 'protein_g': 2.8, 'fat_total_g': 9.5, 'carbohydrates_total_g': 24},
    'картофель пюре': {'name': 'Картофельное пюре', 'calories': 106, 'protein_g': 2.5, 'fat_total_g': 4.2, 'carbohydrates_total_g': 14},
    ...
    'капуста': {'name': 'Капуста белокачанная', 'calories': 25, 'protein_g': 1.3, 'fat_total_g': 0.1, 'carbohydrates_total_g': 6},
    'капуста цветная': {'name': 'Капуста цветная', 'calories': 25, 'protein_g': 2, 'fat_total_g': 0.3, 'carbohydrates_total_g': 5},
    'брокколи': {'name': 'Брокколи', 'calories': 34, 'protein_g': 2.8, 'fat_total_g': 0.4, 'carbohydrates_total_g': 7},
    'цветная капуста': {'name': 'Цветная капуста', 'calories': 25, 'protein_g': 2, 'fat_total_g': 0.3, 'carbohydrates_total_g': 5},
    'брюссельская капуста': {'name': 'Брюссельская капуста', 'calories': 43, 'protein_g': 3.4, 'fat_total_g': 0.3, 'carbohydrates_total_g': 9},
    'пекинская капуста': {'name': 'Пекинская капуста', 'calories': 16, 'protein_g': 1.2, 'fat_total_g': 0.2, 'carbohydrates_total_g': 3},
    ...
    'лук зеленый': {'name': 'Лук зеленый', 'calories': 27, 'protein_g': 1.8, 'fat_total_g': 0.2, 'carbohydrates_total_g': 5},
    'чеснок': {'name': 'Чеснок', 'calories': 149, 'protein_g': 6.4, 'fat_total_g': 0.5, 'carbohydrates_total_g': 33},
    'перец болгарский': {'name': 'Перец болгарский', 'calories': 27, 'protein_g': 1, 'fat_total_g': 0.3, 'carbohydrates_total_g': 6},
    'перец чили': {'name': 'Перец чили', 'calories': 40, 'protein_g': 2, 'fat_total_g': 0.2, 'carbohydrates_total_g': 9},
    ...
    'горошек зеленый': {'name': 'Горошек зеленый', 'calories': 81, 'protein_g': 5.4, 'fat_total_g': 0.4, 'carbohydrates_total_g': 14},
    'кукуруза': {'name': 'Кукуруза', 'calories': 86, 'protein_g': 3.2, 'fat_total_g': 1.2, 'carbohydrates_total_g': 19},
    'кукуруза консервированная': {'name': 'Кукуруза консервированная', 'calories': 58, 'protein_g': 2.2, 'fat_total_g': 0.4, 'carbohydrates_total_g': 13},
    'фасоль': {'name': 'Фасоль', 'calories': 93, 'protein_g': 7, 'fat_total_g': 0.5, 'carbohydrates_total_g': 17},
    'фасоль консервированная': {'name': 'Фасоль консервированная', 'calories': 84, 'protein_g': 5.4, 'fat_total_g': 0.4, 'carbohydrates_total_g': 15},
    'горох консервированный': {'name': 'Горох консервированный', 'calories': 69, 'protein_g': 3.6, 'fat_total_g': 0.2, 'carbohydrates_total_g': 13},
    ...
    'салат': {'name': 'Салат листовой', 'calories': 15, 'protein_g': 1.4, 'fat_total_g': 0.2, 'carbohydrates_total_g': 2.9},
    'салат айсберг': {'name': 'Салат айсберг', 'calories': 14, 'protein_g': 0.9, 'fat_total_g': 0.1, 'carbohydrates_total_g': 3},
    ...
    'сельдерей': {'name': 'Сельдерей', 'calories': 16, 'protein_g': 0.7, 'fat_total_g': 0.2, 'carbohydrates_total_g': 3},
    'сельдерей стебель': {'name': 'Сельдерей стебель', 'calories': 16, 'protein_g': 0.7, 'fat_total_g': 0.2, 'carbohydrates_total_g': 3},
    'сельдерей корень': {'name': 'Сельдерей корень', 'calories': 42, 'protein_g': 1.5, 'fat_total_g': 0.3, 'carbohydrates_total_g': 9},
    ...
    'апельсины': {'name': 'Апельсины', 'calories': 43, 'protein_g': 0.9, 'fat_total_g': 0.1, 'carbohydrates_total_g': 11},
    'мандарин': {'name': 'Мандарин', 'calories': 53, 'protein_g': 0.8, 'fat_total_g': 0.3, 'carbohydrates_total_g': 13},
    'мандарины': {'name': 'Мандарины', 'calories': 53, 'protein_g': 0.8, 'fat_total_g': 0.3, 'carbohydrates_total_g': 13},
    ...
    'грейпфрут': {'name': 'Грейпфрут', 'calories': 42, 'protein_g': 0.8, 'fat_total_g': 0.1, 'carbohydrates_total_g': 11},
    ...
    'чернослив': {'name': 'Чернослив', 'calories': 240, 'protein_g': 2.2, 'fat_total_g': 0.4, 'carbohydrates_total_g': 64},
    ...
    'смородина': {'name': 'Смородина', 'calories': 56, 'protein_g': 1.4, 'fat_total_g': 0.2, 'carbohydrates_total_g': 13},
    'смородина красная': {'name': 'Смородина красная', 'calories': 56, 'protein_g': 1.4, 'fat_total_g': 0.2, 'carbohydrates_total_g': 13},
    'смородина черная': {'name': 'Смородина черная', 'calories': 63, 'protein_g': 1.4, 'fat_total_g': 0.4, 'carbohydrates_total_g': 15},
    'крыжовник': {'name': 'Крыжовник', 'calories': 44, 'protein_g': 0.9, 'fat_total_g': 0.6, 'carbohydrates_total_g': 10},
    ...
    'орехи': {'name': 'Орехи грецкие', 'calories': 654, 'protein_g': 15, 'fat_total_g': 65, 'carbohydrates_total_g': 14},
    'грецкие орехи': {'name': 'Орехи грецкие', 'calories': 654, 'protein_g': 15, 'fat_total_g': 65, 'carbohydrates_total_g': 14},
    ...
    'кедровые орехи': {'name': 'Кедровые орехи', 'calories': 673, 'protein_g': 14, 'fat_total_g': 68, 'carbohydrates_total_g': 13},
    'бразильский орех': {'name': 'Бразильский орех', 'calories': 656, 'protein_g': 14, 'fat_total_g': 66, 'carbohydrates_total_g': 12},
    'семечки подсолнечника': {'name': 'Семечки подсолнечника', 'calories': 578, 'protein_g': 21, 'fat_total_g': 49, 'carbohydrates_total_g': 20},
    'семечки тыквенные': {'name': 'Семечки тыквенные', 'calories': 559, 'protein_g': 30, 'fat_total_g': 49, 'carbohydrates_total_g': 11},
    'семена льна': {'name': 'Семена льна', 'calories': 534, 'protein_g': 18, 'fat_total_g': 42, 'carbohydrates_total_g': 29},
    'семена чиа': {'name': 'Семена чиа', 'calories': 486, 'protein_g': 17, 'fat_total_g': 31, 'carbohydrates_total_g': 42},
    'семена кунжута': {'name': 'Семена кунжута', 'calories': 573, 'protein_g': 18, 'fat_total_g': 50, 'carbohydrates_total_g': 23},
    ...
    'чай зеленый': {'name': 'Чай зеленый', 'calories': 1, 'protein_g': 0, 'fat_total_g': 0, 'carbohydrates_total_g': 0.3},
    'чай травяной': {'name': 'Чай травяной', 'calories': 1, 'protein_g': 0, 'fat_total_g': 0, 'carbohydrates_total_g': 0.3},
    'чай каркаде': {'name': 'Чай каркаде', 'calories': 5, 'protein_g': 0.3, 'fat_total_g': 0, 'carbohydrates_total_g': 1},
    'кофе': {'name': 'Кофе', 'calories': 1, 'protein_g': 0.1, 'fat_total_g': 0, 'carbohydrates_total_g': 0},
    'кофе черный': {'name': 'Кофе черный', 'calories': 1, 'protein_g': 0.1, 'fat_total_g': 0, 'carbohydrates_total_g': 0},
    'кофе с молоком': {'name': 'Кофе с молоком', 'calories': 40, 'protein_g': 1.5, 'fat_total_g': 1.2, 'carbohydrates_total_g': 6},
    'кофе латте': {'name': 'Кофе латте', 'calories': 120, 'protein_g': 6, 'fat_total_g': 5, 'carbohydrates_total_g': 12},
    'кофе капучино': {'name': 'Кофе капучино', 'calories': 80, 'protein_g': 4, 'fat_total_g': 3, 'carbohydrates_total_g': 8},
    'кофе американо': {'name': 'Кофе американо', 'calories': 1, 'protein_g': 0.1, 'fat_total_g': 0, 'carbohydrates_total_g': 0},
    'какао': {'name': 'Какао', 'calories': 228, 'protein_g': 20, 'fat_total_g': 14, 'carbohydrates_total_g': 58},
    'какао с молоком': {'name': 'Какао с молоком', 'calories': 89, 'protein_g': 3, 'fat_total_g': 3, 'carbohydrates_total_g': 13},
    'горячий шоколад': {'name': 'Горячий шоколад', 'calories': 77, 'protein_g': 2, 'fat_total_g': 2, 'carbohydrates_total_g': 14},
    'сахар': {'name': 'Сахар', 'calories': 387, 'protein_g': 0, 'fat_total_g': 0, 'carbohydrates_total_g': 100},
    'сахарная пудра': {'name': 'Сахарная пудра', 'calories': 389, 'protein_g': 0, 'fat_total_g': 0, 'carbohydrates_total_g': 100},
    'мед': {'name': 'Мед', 'calories': 304, 'protein_g': 0.3, 'fat_total_g': 0, 'carbohydrates_total_g': 82},
    'шоколад': {'name': 'Шоколад молочный', 'calories': 546, 'protein_g': 5, 'fat_total_g': 31, 'carbohydrates_total_g': 61},
    'шоколад молочный': {'name': 'Шоколад молочный', 'calories': 546, 'protein_g': 5, 'fat_total_g': 31, 'carbohydrates_total_g': 61},
    'шоколад черный': {'name': 'Шоколад черный', 'calories': 539, 'protein_g': 6.2, 'fat_total_g': 35, 'carbohydrates_total_g': 48},
    'шоколад темный': {'name': 'Шоколад темный', 'calories': 539, 'protein_g': 6.2, 'fat_total_g': 35, 'carbohydrates_total_g': 48},
    'шоколад белый': {'name': 'Шоколад белый', 'calories': 541, 'protein_g': 4.3, 'fat_total_g': 32, 'carbohydrates_total_g': 59},
    ...
    'мармелад': {'name': 'Мармелад', 'calories': 290, 'protein_g': 0.1, 'fat_total_g': 0.1, 'carbohydrates_total_g': 76},
    ...
    'печенье овсяное': {'name': 'Печенье овсяное', 'calories': 437, 'protein_g': 6.5, 'fat_total_g': 17, 'carbohydrates_total_g': 66},
    'печенье песочное': {'name': 'Печенье песочное', 'calories': 458, 'protein_g': 6, 'fat_total_g': 20, 'carbohydrates_total_g': 65},
    ...
    'мороженое': {'name': 'Мороженое', 'calories': 207, 'protein_g': 3.7, 'fat_total_g': 11, 'carbohydrates_total_g': 24},
    'мороженое пломбир': {'name': 'Мороженое пломбир', 'calories': 227, 'protein_g': 3.2, 'fat_total_g': 15, 'carbohydrates_total_g': 20},
    'мороженое эскимо': {'name': 'Мороженое эскимо', 'calories': 270, 'protein_g': 4, 'fat_total_g': 20, 'carbohydrates_total_g': 20},
    'сгущенка': {'name': 'Сгущенное молоко', 'calories': 320, 'protein_g': 7, 'fat_total_g': 9, 'carbohydrates_total_g': 56},
    'сгущенное молоко': {'name': 'Сгущенное молоко', 'calories': 320, 'protein_g': 7, 'fat_total_g': 9, 'carbohydrates_total_g': 56},
    'масло': {'name': 'Масло подсолнечное', 'calories': 884, 'protein_g': 0, 'fat_total_g': 100, 'carbohydrates_total_g': 0},
    'масло подсолнечное': {'name': 'Масло подсолнечное', 'calories': 884, 'protein_g': 0, 'fat_total_g': 100, 'carbohydrates_total_g': 0},
    'масло оливковое': {'name': 'Масло оливковое', 'calories': 898, 'protein_g': 0, 'fat_total_g': 100, 'carbohydrates_total_g': 0},
    'масло сливочное': {'name': 'Сливочное масло', 'calories': 717, 'protein_g': 1, 'fat_total_g': 81, 'carbohydrates_total_g': 1},
    'масло сливочное 82%': {'name': 'Сливочное масло 82%', 'calories': 748, 'protein_g': 0.5, 'fat_total_g': 82, 'carbohydrates_total_g': 0.8},
    'масло растительное': {'name': 'Масло растительное', 'calories': 884, 'protein_g': 0, 'fat_total_g': 100, 'carbohydrates_total_g': 0},
    'масло кукурузное': {'name': 'Масло кукурузное', 'calories': 899, 'protein_g': 0, 'fat_total_g': 100, 'carbohydrates_total_g': 0},
    'масло льняное': {'name': 'Масло льняное', 'calories': 884, 'protein_g': 0, 'fat_total_g': 100, 'carbohydrates_total_g': 0},
    'масло кокосовое': {'name': 'Масло кокосовое', 'calories': 862, 'protein_g': 0, 'fat_total_g': 100, 'carbohydrates_total_g': 0},
    ...
    'суп куриный': {'name': 'Суп куриный', 'calories': 45, 'protein_g': 4, 'fat_total_g': 2, 'carbohydrates_total_g': 3},
    'суп овощной': {'name': 'Суп овощной', 'calories': 40, 'protein_g': 2, 'fat_total_g': 1, 'carbohydrates_total_g': 6},
    'суп грибной': {'name': 'Суп грибной', 'calories': 45, 'protein_g': 2, 'fat_total_g': 2, 'carbohydrates_total_g': 6},
    'суп гороховый': {'name': 'Суп гороховый', 'calories': 66, 'protein_g': 4, 'fat_total_g': 2, 'carbohydrates_total_g': 9},
    'суп с фрикадельками': {'name': 'Суп с фрикадельками', 'calories': 55, 'protein_g': 5, 'fat_total_g': 2, 'carbohydrates_total_g': 5},
    'суп вермишелевый': {'name': 'Суп вермишелевый', 'calories': 50, 'protein_g': 3, 'fat_total_g': 1, 'carbohydrates_total_g': 8},
    'суп рисовый': {'name': 'Суп рисовый', 'calories': 48, 'protein_g': 3, 'fat_total_g': 1, 'carbohydrates_total_g': 8},
    'суп гречневый': {'name': 'Суп гречневый', 'calories': 47, 'protein_g': 3, 'fat_total_g': 1, 'carbohydrates_total_g': 7},
    ...
    'щи из квашеной капусты': {'name': 'Щи из квашеной капусты', 'calories': 80, 'protein_g': 3, 'fat_total_g': 4, 'carbohydrates_total_g': 9},
    ...
    'суп с клецками': {'name': 'Суп с клецками', 'calories': 70, 'protein_g': 3, 'fat_total_g': 3, 'carbohydrates_total_g': 8},
    'томатный суп': {'name': 'Томатный суп', 'calories': 60, 'protein_g': 2, 'fat_total_g': 3, 'carbohydrates_total_g': 7},
    ...
    'суп с фасолью': {'name': 'Суп с фасолью', 'calories': 70, 'protein_g': 4, 'fat_total_g': 3, 'carbohydrates_total_g': 8},
    'суп с чечевицей': {'name': 'Суп с чечевицей', 'calories': 68, 'protein_g': 5, 'fat_total_g': 2, 'carbohydrates_total_g': 8},
    'суп харчо': {'name': 'Суп харчо', 'calories': 88, 'protein_g': 4, 'fat_total_g': 5, 'carbohydrates_total_g': 7},
    'суп солянка': {'name': 'Суп солянка', 'calories': 95, 'protein_g': 5, 'fat_total_g': 6, 'carbohydrates_total_g': 5},
    'суп рассольник': {'name': 'Суп рассольник', 'calories': 72, 'protein_g': 3, 'fat_total_g': 3, 'carbohydrates_total_g': 8},
    ...
    'вареники': {'name': 'Вареники', 'calories': 203, 'protein_g': 7.6, 'fat_total_g': 5.7, 'carbohydrates_total_g': 32},
    'блины': {'name': 'Блины', 'calories': 233, 'protein_g': 6.1, 'fat_total_g': 8.7, 'carbohydrates_total_g': 32},
    'блины с творогом': {'name': 'Блины с творогом', 'calories': 195, 'protein_g': 10, 'fat_total_g': 8, 'carbohydrates_total_g': 22},
    'блины с мясом': {'name': 'Блины с мясом', 'calories': 256, 'protein_g': 13, 'fat_total_g': 14, 'carbohydrates_total_g': 22},
    ...
    'котлеты куриные': {'name': 'Котлеты куриные', 'calories': 210, 'protein_g': 18, 'fat_total_g': 14, 'carbohydrates_total_g': 4},
    'котлеты рыбные': {'name': 'Котлеты рыбные', 'calories': 168, 'protein_g': 16, 'fat_total_g': 10, 'carbohydrates_total_g': 4},
    ...
    'пирожок с капустой': {'name': 'Пирожок с капустой', 'calories': 225, 'protein_g': 5, 'fat_total_g': 9, 'carbohydrates_total_g': 31},
    'пирожок с мясом': {'name': 'Пирожок с мясом', 'calories': 245, 'protein_g': 9, 'fat_total_g': 12, 'carbohydrates_total_g': 26},
    'пирожок с картошкой': {'name': 'Пирожок с картошкой', 'calories': 235, 'protein_g': 5, 'fat_total_g': 10, 'carbohydrates_total_g': 32},
    ...
    'чизбургер': {'name': 'Чизбургер', 'calories': 303, 'protein_g': 15, 'fat_total_g': 13, 'carbohydrates_total_g': 30},
    'картофель фри': {'name': 'Картофель фри', 'calories': 312, 'protein_g': 3.4, 'fat_total_g': 15, 'carbohydrates_total_g': 41},
    ...
    'соевый соус': {'name': 'Соевый соус', 'calories': 53, 'protein_g': 6, 'fat_total_g': 0, 'carbohydrates_total_g': 10},
    'соус тартар': {'name': 'Соус тартар', 'calories': 311, 'protein_g': 0.9, 'fat_total_g': 33, 'carbohydrates_total_g': 3},
    'соус бешамель': {'name': 'Соус бешамель', 'calories': 147, 'protein_g': 4, 'fat_total_g': 11, 'carbohydrates_total_g': 9},
    'сметанный соус': {'name': 'Сметанный соус', 'calories': 205, 'protein_g': 3, 'fat_total_g': 20, 'carbohydrates_total_g': 5},
    'томатный соус': {'name': 'Томатный соус', 'calories': 74, 'protein_g': 1.5, 'fat_total_g': 3.5, 'carbohydrates_total_g': 10},
    'соус барбекю': {'name': 'Соус барбекю', 'calories': 172, 'protein_g': 1.5, 'fat_total_g': 0.7, 'carbohydrates_total_g': 40},
    ...
    'перец': {'name': 'Перец черный', 'calories': 251, 'protein_g': 10, 'fat_total_g': 3.3, 'carbohydrates_total_g': 64},
    ...
    'вино белое': {'name': 'Вино белое', 'calories': 82, 'protein_g': 0.1, 'fat_total_g': 0, 'carbohydrates_total_g': 2.6},
    ...
    'шампанское': {'name': 'Шампанское', 'calories': 84, 'protein_g': 0.2, 'fat_total_g': 0, 'carbohydrates_total_g': 2},
}
...
async def search_product_api(product_name: str):
    ...
    emoji_to_product = {
        '🍞': 'хлеб', '🥖': 'батон', '🍳': 'яйцо', '🥚': 'яйцо', '🥛': 'молоко',
        '🧀': 'сыр', '🍗': 'курица', '🥩': 'говядина', '🐟': 'лосось', '🍚': 'рис',
        '🍜': 'макароны', '🥔': 'картофель', '🥕': 'морковь', '🍅': 'помидор',
        '🥒': 'огурец', '🍎': 'яблоко', '🍌': 'банан', '🍊': 'апельсин',
        '🥜': 'орехи', '☕': 'кофе', '🍫': 'шоколад', '🍲': 'суп', '🥗': 'салат',
        '🥣': 'каша', '🍪': 'печенье', '🍩': 'пончик', '🍦': 'мороженое',
        '🥐': 'круассан', '🥪': 'сэндвич', '🌭': 'хот-дог', '🍕': 'пицца',
        '🍔': 'бургер', '🍟': 'картофель фри', '🥞': 'блины', '🧇': 'вафли',
        '🍯': 'мед', '🍵': 'чай', '🍷': 'вино', '🍺': 'пиво', '🥂': 'шампанское',
        '🥃': 'виски', '🍸': 'коктейль', '🍹': 'тропический коктейль', '🍶': 'саке',
        '🍾': 'шампанское', '🧃': 'сок', '🥤': 'газировка', '🧊': 'лед',
        '🍽️': 'еда', '🍴': 'приборы', '🥄': 'ложка', '🍽': 'тарелка',
        '🥡': 'еда на вынос', '🧂': 'соль', '🥫': 'консервы', '🍤': 'креветки',
        '🥮': 'лунный пирог', '🍡': 'данго', '🥟': 'пельмени', '🥠': 'печенье с предсказанием',
        '🥧': 'пирог', '🍰': 'торт', '🎂': 'торт на день рождения', '🧁': 'кекс',
        '🍢': 'оден', '🍣': 'суши', '🍥': 'рыбный пирог', '🍘': 'рисовые крекеры',
        '🍙': 'онигири', '🍛': 'карри с рисом', '🍝': 'спагетти', '🍠': 'печеный картофель',
        '🍬': 'конфета', '🍭': 'леденец', '🍮': 'крем', '🍼': 'детская бутылочка',
        '🍻': 'чокание бокалами', '🧉': 'мате', '🥢': 'палочки для еды', '🔪': 'нож',
        '🏺': 'амфора', '🧇': 'вафли', '🥮': 'лунный пирог', '🍡': 'данго',
        '🍢': 'оден', '🍣': 'суши', '🍤': 'креветки темпура', '🍥': 'рыбный пирог',
    }
    ...
    category_defaults = {
        'суп': {'name': 'Суп (среднее значение)', 'calories': 60, 'protein_g': 3, 'fat_total_g': 2, 'carbohydrates_total_g': 8},
        'салат': {'name': 'Салат (среднее значение)', 'calories': 80, 'protein_g': 4, 'fat_total_g': 5, 'carbohydrates_total_g': 6},
        'каша': {'name': 'Каша (среднее значение)', 'calories': 120, 'protein_g': 4, 'fat_total_g': 2, 'carbohydrates_total_g': 25},
        'сок': {'name': 'Сок (среднее значение)', 'calories': 45, 'protein_g': 0.5, 'fat_total_g': 0.1, 'carbohydrates_total_g': 11},
        'компот': {'name': 'Компот (среднее значение)', 'calories': 60, 'protein_g': 0.2, 'fat_total_g': 0.1, 'carbohydrates_total_g': 15},
        'напиток': {'name': 'Напиток (среднее значение)', 'calories': 30, 'protein_g': 0, 'fat_total_g': 0, 'carbohydrates_total_g': 8},
        'десерт': {'name': 'Десерт (среднее значение)', 'calories': 300, 'protein_g': 5, 'fat_total_g': 15, 'carbohydrates_total_g': 40},
        'выпечка': {'name': 'Выпечка (среднее значение)', 'calories': 350, 'protein_g': 8, 'fat_total_g': 15, 'carbohydrates_total_g': 50},
        'соус': {'name': 'Соус (среднее значение)', 'calories': 200, 'protein_g': 2, 'fat_total_g': 20, 'carbohydrates_total_g': 10},
    }
...
async def height_step(event: MessageCreated, bot: Bot):
    user_id = event.message.from_user.id
    if user_states.get(user_id) != 'height':
        return

    try:
        height_val = int(event.message.body.text)
...
async def weight_step(event: MessageCreated, bot: Bot):
    user_id = event.message.from_user.id
    if user_states.get(user_id) != 'weight':
        return

    try:
        weight_val = float(event.message.body.text)
...
async def goal_step(event: MessageCreated, bot: Bot):
    user_id = event.message.from_user.id
...
async def activity_step(event: MessageCreated, bot: Bot):
    user_id = event.message.from_user.id
    ...
    cur.execute('''
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ''', (user_id, event.message.from_user.username, event.message.from_user.full_name,
...
async def export_data(event: MessageCreated, bot: Bot):
    if event.message.body.text != "📤 Экспорт данных":
        return
...
async def notification_settings(event: MessageCreated, bot: Bot):
    if event.message.body.text != "⚙️ Настройки":
        return
...
async def handle_notification_time(event: MessageCreated, bot: Bot):
    ...
    time_str = event.message.body.text
...
async def handle_main_menu(event: MessageCreated, bot: Bot):
    ...
    if state == 'gender':
        ...
        await meal_type_handler(event, bot)
        return
